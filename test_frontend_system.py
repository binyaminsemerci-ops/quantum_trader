...
class FrontendSystemTester:
    ...
    def __init__(self, frontend_dir: str = "frontend", backend_url: str = "http://localhost:8000"):
    ...
    def test_frontend_build(self) -> Dict[str, Any]:
        ...
        try:
            ...
            test_result = {
                ...
                "success": result.returncode == 0 and has_dist and len(files_present) >= 1,
                "build_time_seconds": build_time,
                "return_code": result.returncode,
                "has_dist_directory": has_dist,
                "essential_files_present": files_present,
                "build_output_size": self._get_directory_size(dist_dir) if has_dist else 0,
                "stdout": result.stdout[:500] if result.stdout else "",  # First 500 chars
                "stderr": result.stderr[:500] if result.stderr else "",
                "error": None if result.returncode == 0 else f"Build failed with code {result.returncode}"
            }
    ...
    def test_typescript_compilation(self) -> Dict[str, Any]:
        ...
        try:
            ...
            test_result = {
                ...
                "error": None if result.returncode == 0 else f"TypeScript compilation failed"
            }
    ...
    def test_api_integration(self) -> Dict[str, Any]:
        ...
        try:
            ...
            successful_apis = sum(1 for result in api_results if result.get("success", False))
            ...
            test_result = {
                ...
                "error": None if success_rate >= 0.75 else f"Only {success_rate:.1%} of APIs working"
            }
    ...
    def test_static_assets(self) -> Dict[str, Any]:
        ...
        try:
            ...
            successful_assets = sum(1 for result in asset_results if result.get("success", False))
            success_rate = successful_assets / len(asset_results) if asset_results else 0
            ...
            test_result = {
                ...
                "error": None if success_rate >= 0.5 else f"Only {success_rate:.1%} of assets loading"
            }
