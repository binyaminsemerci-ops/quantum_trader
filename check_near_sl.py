...
print(f"\n[SEARCH] NEARUSDT SHORT ANALYSIS")
print(f"Entry: ${entry:.4f}")
print(f"Mark:  ${mark:.4f}")
print(f"Movement: {((mark-entry)/entry)*100:+.3f}%")
print(f"\n[TARGET] REQUIRED SL (0.1% above entry for 2% margin loss on 20x):")
print(f"SL Price: ${entry * 1.001:.4f}")
print(f"\n[WARNING]  PROBLEM:")
if mark > entry * 1.001:
    print(f"❌ Mark price (${mark:.4f}) is ABOVE SL price (${entry*1.001:.4f})!")
    ...
    print(f"[OK] Mark price is below SL - order should work")
