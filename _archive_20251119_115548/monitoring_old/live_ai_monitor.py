...
print("\n" + "=" * 70)
print("🤖 LIVE AI MONITOR - VENTER PÅ 70%+ CONFIDENCE SIGNAL")
print("=" * 70)
print("\n⚙️  KONFIGURASJON:")
print("   • Event-Driven: [OK] Aktiv")
print("   • Check Interval: 10 sekunder")
print("   • Min Confidence: 70%")
print("   • Symbols: 36")
print("   • Cooldown: 120s mellom trades")
print("   • 20x leverage, $1600 per trade")
print("\n[CHART] MONITORING...")
...
try:
        ...
        try:
            ...
            if 'No strong signals' in msg or 'Best BUY' in msg or 'Best SELL' in msg:
                if last_check_time != current_time:
                    print(f"⏰ {current_time} | [SEARCH] AI sjekker signaler...")
            ...
            # Strong signal found!
                ...
                print(f"\n[TARGET] {current_time} | ⚡ STRONG SIGNAL FUNNET!")
                print(f"   {msg}\n")
            
            # Position opened
            elif 'order' in msg.lower() and 'filled' in msg.lower():
                print(f"\n[OK] {current_time} | [CHART_UP] POSISJON ÅPNET!")
                print(f"   {msg}\n")
            
            # TP/SL set
            elif 'TP/SL' in msg or 'TP order' in msg or 'SL order' in msg:
                print(f"[SHIELD]  {current_time} | {msg}")
            
            # Position Monitor check
            elif 'Position check' in msg:
                print(f"[SEARCH] {current_time} | Position Monitor: {msg}")
                
        except json.JSONDecodeError:
            # Not JSON, skip
            continue
        except KeyboardInterrupt:
            print("\n\n⏹️  Monitoring stoppet av bruker")
            break
    ...
    print("\n\n⏹️  Monitoring stoppet")
except Exception as e:
    print(f"\n❌ Error: {e}")

print("\n" + "=" * 70)
print("[SEARCH] For manuell sjekk:")
