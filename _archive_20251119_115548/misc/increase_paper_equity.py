...
def increase_paper_equity(target_equity: float = 1000.0):
    ...
    try:
        ...
        print(f"\n[MONEY] Current Equity: {current_equity:.2f} USDC")
        print(f"[TARGET] Target Equity: {target_equity:.2f} USDC")
        
        if current_equity >= target_equity:
            print(f"[OK] Already at or above target equity!")
            return
        
        # Calculate how much USDC to add
        usdc_to_add = target_equity - current_equity
        
        print(f"\n💵 Adding {usdc_to_add:.2f} USDC to paper account...")
        ...
        print(f"[OK] Successfully added {usdc_to_add:.2f} USDC!")
        print(f"🎉 New total equity: {target_equity:.2f} USDC")
        ...
        print(f"✓ Verified equity: {new_equity:.2f} USDC")
...
if __name__ == "__main__":
    ...
    print("🏦 Paper Trading Equity Manager")
    print("=" * 50)
