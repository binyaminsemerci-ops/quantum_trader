...
# Create model
print("\n" + "=" * 80)
print(" BUILDING TEMPORAL FUSION TRANSFORMER")
print("=" * 80)
...
print("=" * 80)
print(" Estimated time: 15-40 minutes")
...
if best_val_accuracy >= 60:
    ...
    print(f"\n Target not reached. Current: {best_val_accuracy:.1f}%")
    print(" Tips:")
...
print("\n" + "=" * 80)
print(" TEMPORAL FUSION TRANSFORMER READY FOR TRADING!")
print("=" * 80)
