...
async def main(target_samples=20000):
    ...
    print("[CHART] Strategy: Multiple time periods (weeks back)")
    ...
    async with aiohttp.ClientSession() as session:
        for period_name, start_time, interval in periods:
            ...
            for i, symbol in enumerate(symbols, 1):
                ...
                if i % 10 == 0:
                    print(f"   [OK] {i}/{len(symbols)} symbols: {period_samples:,} samples...")
            
            print(f"   [OK] Period complete: {period_samples:,} samples")
