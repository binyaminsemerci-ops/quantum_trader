...
- Method: `systemctl down` → remove containers → `systemctl up -d backend`
...
4. **Review Logs:** `journalctl -u quantum_backend.service --tail 1000 > emergency_log.txt`
...
**Logs Location:** `journalctl -u quantum_backend.service`  
