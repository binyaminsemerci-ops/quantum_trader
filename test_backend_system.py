...
class BackendSystemTester:
    ...
    def test_websocket_connection(self) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "error": None if connection_successful else "Failed to establish WebSocket connection"
            }
    ...
    def test_concurrent_requests(self, num_requests: int = 10) -> Dict[str, Any]:
        ...
        result = {
            ...
            "success": successful_requests >= num_requests * 0.8,  # 80% success rate required
    ...
    def test_ai_integration(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if response.status_code == 200:
                data = response.json()
                has_ai_data = any(key in data for key in ["model_accuracy", "backtest_results", "training_status"])
        ...
        try:
            ...
            for test_name, test_func in tests:
                ...
                try:
                    ...
                    if isinstance(result, list):  # Multiple results (like API endpoints)
                        for r in result:
                            ...
                            if r.get("success", False):
                                ...
                                print(f"  ❌ {r['test_name']}: {r.get('error', 'Failed')}")
                    else:  # Single result
                        test_summary["tests_run"] += 1
