...
class PerformanceMonitor:
    ...
    def _calculate_model_accuracy(self) -> float:
        ...
        correct_predictions = sum(
            1 for pred in recent_predictions if pred.get("correct", False)
        )
    ...
    def _check_alerts(self, metrics: PerformanceMetrics):
        ...
        if (
            ...
            and metrics.model_accuracy < self.alert_config.min_model_accuracy
        ):
            alerts_to_send.append(
                Alert(
                    timestamp=metrics.timestamp,
        ...
        if (
            ...
            and metrics.avg_signal_strength < self.alert_config.min_signal_strength
        ):
            alerts_to_send.append(
                Alert(
                    timestamp=metrics.timestamp,
