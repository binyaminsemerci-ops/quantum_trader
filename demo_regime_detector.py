...
def main():
    ...
    print("\n[OK] RegimeDetector initialized with default config\n")
    
    # Example 1: BTC in normal conditions
    print("[CHART] Example 1: BTC Normal Market")
    print("-" * 60)
    ...
    print(f"\n[CLIPBOARD] Suggested Parameters:")
    ...
    print("\n\n[CHART] Example 2: BTC Flash Crash")
    print("-" * 60)
    ...
    print(f"ADX: 60.0")
    print(f"\n[WARNING]  REGIME: {result2.regime.value}")
    ...
    print("\n\n[CHART] Example 3: Altcoin Consolidation")
    print("-" * 60)
    ...
    print(f"ADX: 15.0")
    print(f"\n[OK] REGIME: {result3.regime.value}")
