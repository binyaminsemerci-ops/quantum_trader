...
class ApplyLayer:
    ...
    def normalize_action(self, action: str, proposal: Dict[str, Any], symbol: str) -> tuple[str, Optional[str]]:
        ...
        # Already standard actions (pass through) — case-insensitive, PARTIAL_25 included
        elif action_upper in ["FULL_CLOSE_PROPOSED", "PARTIAL_75", "PARTIAL_50", "PARTIAL_25", "UPDATE_SL", "HOLD"]:
            action = action_upper  # normalize to uppercase e.g. partial_25 → PARTIAL_25
    ...
    def create_apply_plan(self, symbol: str, proposal: Dict[str, Any]) -> ApplyPlan:
        ...
        if decision == Decision.EXECUTE:
            ...
            _is_open_action = _churn_action not in (
                'FULL_CLOSE_PROPOSED', 'PARTIAL_75', 'PARTIAL_50', 'PARTIAL_25', 'UPDATE_SL', 'HOLD'
            )
            if _is_open_action:
                try:
    ...
    def execute_testnet(self, plan: ApplyPlan) -> ApplyResult:
        ...
        try:
            ...
            for step in plan.steps:
                ...
                try:
                    if step['step'] in ['CLOSE_FULL', 'CLOSE_PARTIAL_75', 'CLOSE_PARTIAL_50', 'CLOSE_PARTIAL_25']:
