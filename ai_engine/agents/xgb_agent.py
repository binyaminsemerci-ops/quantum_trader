...
class XGBAgent:
    ...
    def __init__(
        ...
        # Try v6 (49 features - FEATURES_V6 schema), then v5 (natural class weights), then v4 (RandomOverSampler), then v3, then v2
        latest_model = self._find_latest_model(retraining_dir, "xgb_v6_*.pkl") or \
                       self._find_latest_model(retraining_dir, "xgb_v*_v5.pkl") or \
        ...
        # For v6/v3/v4/v5 models, scaler is named model_name_scaler.pkl
        latest_scaler = self._find_latest_model(retraining_dir, "xgb_v6_*_scaler.pkl") or \
                       self._find_latest_model(retraining_dir, "xgb_v*_v5_scaler.pkl") or \
