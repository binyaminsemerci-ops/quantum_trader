...
from routers import ai_router, portfolio_router, risk_router, system_router, stream_router, ai_insights_router, brains_router, events_router, learning_router, control_router, rl_router, journal_router, incident_router, replay_router, admin_router
...
app.include_router(journal_router.router)  # Trade journal
app.include_router(incident_router.router)  # Incident tracking
app.include_router(replay_router.router)  # Trade replay / decision chain
app.include_router(admin_router.router)  # Admin dashboard
