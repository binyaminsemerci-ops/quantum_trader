...
def masked_config_summary(cfg: Any) -> Dict[str, Any]:
	...
	"""
	return {
		"has_binance_keys": bool(getattr(cfg, "binance_api_key", None) and getattr(cfg, "binance_api_secret", None)),
		"has_coinbase_keys": bool(getattr(cfg, "coinbase_api_key", None) and getattr(cfg, "coinbase_api_secret", None)),
	}
