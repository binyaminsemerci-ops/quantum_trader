...
def load_config() -> Any:
    ...
    ns = SimpleNamespace(
        ...
        binance_api_key=dashboard.get("api_key") or os.environ.get("BINANCE_API_KEY") or "your_binance_testnet_api_key_here",
        binance_api_secret=dashboard.get("api_secret") or os.environ.get("BINANCE_API_SECRET") or "your_binance_testnet_api_secret_here",
