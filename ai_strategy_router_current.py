...
class AIStrategyRouter:
    ...
    def _build_dedup_key(self, symbol: str, side: str, correlation_id: str, trace_id: str, msg_id: str) -> Tuple[str, str, str, str]:
    ...
    async def route_decision(self, decision: dict, trace_id: str, correlation_id: str, msg_id: str):
        ...
        try:
            # Extract symbol and side FIRST for dedup key
