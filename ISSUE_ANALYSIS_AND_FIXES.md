...
4. Docker healthcheck in systemctl.yml references wrong port (8005 instead of 8004)

From systemctl.yml line 498:
```yaml
healthcheck:
...
⚠️ Incorrect healthcheck port in systemctl
```
...
**Add Backend Healthcheck to systemctl.yml**
...
- **Action:** Change port from 8005 to 8004 in systemctl.yml

**3. Add Backend Docker Healthcheck**
- **Effort:** 2 minutter
- **Impact:** Better Docker monitoring
- **Priority:** LOW
- **Action:** Add healthcheck block to backend service in systemctl.yml
