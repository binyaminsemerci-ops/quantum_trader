...
class SimpleFrontendTester:
    ...
    def test_package_json_content(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if not package_json_path.exists():
                ...
                has_dev_script = has_scripts and "dev" in package_data.get("scripts", {})
                has_build_script = has_scripts and "build" in package_data.get("scripts", {})
                
                checks = [has_name, has_scripts, has_dependencies, has_dev_script, has_build_script]
    ...
    def run_simple_tests(self) -> Dict[str, Any]:
        ...
        if package_result["success"]:
            ...
            print(f"  ⚠️ Package.json issues: {package_result.get('error', 'Invalid content')}")
        ...
        if npm_result["success"]:
            print(f"  ✅ npm available (version: {npm_result.get('npm_version', 'unknown')})")
            ...
            if deps_result["success"]:
                ...
                print(f"  ⚠️ Dependency issues: {deps_result.get('error', 'Unknown issue')}")
        else:
