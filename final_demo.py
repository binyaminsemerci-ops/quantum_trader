...
async def final_demo():
    ...
    print(f'   • Market data (CoinGecko, CoinPaprika)')
    print(f'   • Community sentiment (Reddit, Twitter)')
    print(f'   • Market psychology (Fear & Greed Index)')  
    print(f'   • News sentiment (CryptoCompare)')
    print(f'   • Global market indicators')
    print(f'   • AI-extracted insights & regime detection')
