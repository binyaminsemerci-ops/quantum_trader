...
print("🔄 Retraining Ensemble Model with sklearn 1.7.2...")
print("")
...
print("[CHART] Generating sample training data...")
np.random.seed(42)
n_samples = 1000
n_features = 50
...
print("[ROCKET] Creating fresh ensemble...")
ensemble = EnsemblePredictor(models_dir="/app/ai_engine/models")
print("")

print("⚙️  Training ensemble (this may take 1-2 minutes)...")
ensemble.fit(X_train, y_train, X_val, y_val)
print("")

# Evaluate
print("[CHART_UP] Evaluating ensemble performance...")
...
# Save
print("💾 Saving new ensemble model...")
ensemble.save("ensemble_model.pkl")
print(f"   [OK] Saved to /app/ai_engine/models/ensemble_model.pkl")
print("")
...
if model_path.exists():
    ...
    print(f"   [OK] Ensemble loaded successfully")
...
print("")
print("=" * 60)
print("[OK] ENSEMBLE RETRAINING COMPLETED!")
print("=" * 60)
print("")
