...
def test_valid_order():
    ...
    valid, reason = rm.validate_order(balance=10000, qty=0.05, price=20000, stop_loss=19000)
...
def test_bad_stop_loss():
    ...
    valid, reason = rm.validate_order(balance=10000, qty=0.05, price=20000, stop_loss=21000)
    assert valid is False
